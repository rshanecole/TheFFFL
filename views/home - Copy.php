...
?>     
			...
			<div class="row row-eq-height" style="margin-top:0px;margin-bottom:5px; background-color:white;border-top-left-radius:10px;border-top-right-radius:10px;border-bottom-left-radius:0px; border-bottom-right-radius:0px;padding:15px;">
				<!--container for league headlines and cbs-->	
               	<div class="col-xs-24 col-sm-16"> 
               		<div class="row">
                    	<!--League Headlines-->
                        <div class="col-xs-24 " style="margin-bottom:5px;padding-right:5px;max-height:125px;border:solid #ccc 1px; border-radius:5px;overflow:hidden">
                       
                            
                             <? if($week>0){ ;//in season display ?>
                             		<div class="row">
                        ...
                        <div class="col-xs-24 " style="padding-right:5px;max-height:125px;border:solid #ccc 1px; border-radius:5px;overflow:hidden;">
                            
                        	<div class="row" style="padding:5px;">
                            	<div class="col-xs-8">
                                    <a href="<? echo $marquee['link']; ?>">
                                        <img class="img-responsive img-rounded "  src="<? echo $marquee['img']; ?>">
                               		</a>
                               	</div>
                                <div clss="col-xs-16">
                                	<a href="<? echo $marquee['link']; ?>">
                                        <h4 class="text-center hidden-xs"><img class="img-responsive" style="float:left" width="10%" src="<? echo base_url().'assets/img/logos/cbs.jpg'; ?>"><? echo str_replace(' By','<br>By',$marquee['text']); ?></h4>
                                        <h6 class="text-center hidden-sm hidden-md hidden-lg"><img class="img-responsive" style="float:left" width="15%" src="<? echo base_url().'assets/img/logos/cbs.jpg'; ?>"><? echo str_replace(' By','<br>By',$marquee['text']); ?></h6>
                                    </a>
                               	</div>
                            </div>
            ...
            <!--NFL Headlines-->
                ...
                <div class="hidden-xs col-sm-8 col-md-8" style="padding-right:5px;">
                    <div class="col-xs-24 text-center" style="padding:5px;padding-bottom:0px;border:solid #ccc 1px; border-radius:5px;max-height:230px;overflow:auto">
