...
?>
    ...
    <div class="col-xs-24 " >
     <div class="panel panel-primary blue_panel-primary " >
        <div class="panel-heading blue_panel-heading">
            <h4 class="panel-title blue_panel-title text-center"><small>Career Scoring</small></h4>
        </div>
    ...
    display: inline-block;border-right:solid #ccc 1px;width:45px;">'.$year.'</td>';
						...
						echo '<td class="text-center"><a href="'.base_url().'Player/rankings/'.$year.'">'.$this->session->userdata['ranks'][$year].'</a></td>';					
