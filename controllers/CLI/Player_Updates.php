...
Class Player_Updates extends CI_Controller
{
	...
	public function index()
	{
		...
		//update injuries from cbs
		$week = $this->Leagues->get_current_week(1);
		$year = $this->Leagues->get_current_season(1);
		$player_data = $this->Player_Updater->cbs_injury_details_json_array($week);
