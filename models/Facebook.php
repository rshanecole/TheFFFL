...
Class Facebook_Interact extends CI_Model 
{
	...
	public function post_to_facebook($message,$league_id){
		...
		$facebook_query = $this->db->where('league_id',$leagu_id)
									->get('Facebook_Settings');
		$facebook_array = $facebook_query->result_array();
		
		$config = array();
		$config['appId'] = $facebook_array['appId'];
		$config['secret'] = $facebook_array['secret'];
		$config['fileUpload'] = false; // optional
		$fb = new Facebook($config);
		$access_token = $facebook_array['access_token'];
		$params = array(
		...
		try {
		  $ret = $fb->api($facebook_array['api'], 'POST', $params);
